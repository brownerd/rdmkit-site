...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../node_modules/rdmkit-mzr/src/index.js":[function(require,module,exports) {
module.exports = () => {
...
var _rdmkitMzr = _interopRequireDefault(require("rdmkit-mzr"));

var _rdmkitCpl = _interopRequireDefault(require("rdmkit-cpl"));

var _rdmkitVrt = _interopRequireDefault(require("rdmkit-vrt"));

var _rdmkitRdm = _interopRequireDefault(require("rdmkit-rdm"));
...
spacing.addEventListener("click", function () {
  ...
  try {
    for (var _iterator = pagraphs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var p = _step.value;
...
hierarchy.addEventListener("click", function () {
  ...
  try {
    for (var _iterator2 = hgroups[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      var h = _step2.value;
...
//# sourceMappingURL=/src.80dfb952.map